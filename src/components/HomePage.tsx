              ...
              <div className="divide-y divide-gray-200 dark:divide-gray-700">
                {notifications.map((notification) => (
                  <div
                    ...
                    className={`p-4 cursor-pointer transition-all duration-200 hover:scale-[1.02] transform ${!notification.is_read
                        ? theme === 'dark'
            ...
            >
              ...
              >
                ...
                {selectedNotification.actor && (
                  <div className="flex items-center space-x-2 mt-3 p-2 rounded-lg bg-opacity-50 bg-gray-200 dark:bg-gray-600 animate-fadeIn">
                    <img
            ...
            {quiz.answers.map((option) => {
              ...
              return (
                ...
                >
                  ...
                  {status === "correct-selected" && <Check size={22} className="text-green-500 animate-bounce" />}
                  {status === "incorrect-selected" && <X size={22} className="text-red-500 animate-bounce" />}
                  {status === "correct-unselected" && <Check size={22} className="text-green-500 animate-bounce" />}
                </button>
              )
            })}
          </div>
          ...
          {quiz.answers.map((option) => {
            ...
            return (
              ...
              >
                ...
                {status === "correct-selected" && <Check size={24} className="text-green-500 animate-bounce" />}
                {status === "incorrect-selected" && <X size={24} className="text-red-500 animate-bounce" />}
                {status === "correct-unselected" && <Check size={24} className="text-green-500 animate-bounce" />}
              </button>
            )
          })}
        </div>
        ...
        <section className="space-y-6">
          {quizzes.map((quiz, index) => (
            <article
              ...
              className={`rounded-2xl p-4 sm:p-6 shadow-lg border transition-all duration-200 hover:scale-[1.02] transform animate-slideInUp ${theme === "dark" ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"
                }`}
              style={{ animationDelay: `${index * 100}ms` }}
            >
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-6">
                <div className="flex items-center space-x-3">
                  <a href={`/profile/${quiz.user?.username}`}>
                    <div className="flex items-center space-x-3 hover:scale-105 transform transition-all duration-200">
                      <div
                        className={`w-10 h-10 rounded-full overflow-hidden flex items-center justify-center ring-2 ring-blue-500/20 ${theme === "dark" ? "bg-gray-700" : "bg-gray-100"
                          }`}
                      >
                      ...
                      <div>
                        <div className="flex items-center space-x-1">
                          ...
                          {quiz.user.is_badged && <CheckCircle size={16} className="text-blue-500 animate-pulse" />}
                        </div>
                        <div
                          className={`text-xs ${theme === "dark" ? "text-gray-400" : "text-gray-500"
                            }`}
                ...
                <div className="flex items-center justify-between sm:justify-end gap-3">
                  <div
                    className={`px-3 py-1 rounded-full text-xs font-medium animate-pulse ${getDifficultyColor(
              ...
              >
                ...
                <div className="flex items-center justify-end space-x-3">
                  <button
                    className={`p-3 rounded-full transition-all duration-200 hover:scale-110 transform ${theme === "dark" ? "hover:bg-gray-700 text-gray-400" : "hover:bg-gray-100 text-gray-600"
                      }`}
                  ...
                  <button
                    ...
                    className={`p-3 rounded-full transition-all duration-200 hover:scale-110 transform ${theme === "dark" ? "hover:bg-gray-700" : "hover:bg-gray-100"
                      }`}
                  >
                    <Bookmark
                      size={20}
