...
function CardsMarket() {
    ...
    return (
        <div className="flex w-full h-full bg-gray-800">
            <div className={"flex flex-col items-start justify-start bg-gray-800 w-1/3 mx-auto shadow-2xl min-h-screen"}>
                {/*    /!* Navigation *!/*/}
                ...
                {/*        })}*/}
                {/*    </div>*/}
                <h1 className={"flex m-auto text-white text-4xl"}>Coming Soon</h1>
            </div>
        </div>
    );
}
