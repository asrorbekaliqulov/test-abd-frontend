...
const CreateLiveQuiz: React.FC<CreateLiveQuizProps> = ({ theme, toggleTheme }) => {
  ...
  const ErrorDisplay = ({ error, onRetry, type }: { error: string; onRetry: () => void; type: string }) => (
    ...
    >
      ...
      {error.includes("403") && (
        <div className="text-xs mb-3 p-2 rounded bg-yellow-100 dark:bg-yellow-900/20 text-yellow-800 dark:text-yellow-300">
          <strong>Yechim:</strong> Tizimga kiring yoki NEXT_PUBLIC_API_URL environment variable ni to'g'ri sozlang
        </div>
      )}
      {error.includes("404") && (
        <div className="text-xs mb-3 p-2 rounded bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300">
          <strong>Yechim:</strong> Backend serverda tegishli endpoint mavjudligini tekshiring
        </div>
      )}
      {error.includes("Tarmoq") && (
        <div className="text-xs mb-3 p-2 rounded bg-orange-100 dark:bg-orange-900/20 text-orange-800 dark:text-orange-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
        ...
        >
          <div className="flex flex-col items-center space-y-4">
            <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center group-hover:animate-pulse">
              <Zap size={32} className="text-white" />
            </div>
            <h3 className={`text-xl font-bold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Hozir boshlash</h3>
            ...
            <div className="flex items-center space-x-2 mt-4">
              ...
              <span className={`text-sm font-medium ${theme === "dark" ? "text-green-300" : "text-green-600"}`}>
                Tezkor
              </span>
            </div>
          </div>
        ...
        >
          <div className="flex flex-col items-center space-y-4">
            <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center group-hover:animate-pulse">
      ...
      >
        ...
        {errors.myQuizzes ? (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      <Edit3 size={16} className={theme === "dark" ? "text-gray-300" : "text-gray-600"} />
                    </button>
                    <button
                      className={`p-2 rounded-lg transition-colors ${
                        theme === "dark" ? "hover:bg-gray-600" : "hover:bg-gray-100"
          ...
          <div className="text-center py-8">
            <Trophy size={48} className={`mx-auto mb-4 ${theme === "dark" ? "text-gray-500" : "text-gray-400"}`} />
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {errors.myTests ? (
              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                {tests.myTests.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    <p className={`${theme === "dark" ? "text-gray-400" : "text-gray-500"}`}>Hali testlaringiz yo'q</p>
                  </div>
                )}
              </div>
            )}
          ...
          >
            ...
            {errors.publicTests ? (
              <ErrorDisplay error={errors.publicTests} onRetry={() => retryFetch("publicTests")} type="publicTests" />
            ) : (
              <div className="space-y-3 max-h-96 overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-left">
                    <h4 className={`font-medium ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Erkin rejim</h4>
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-left">
                    <h4 className={`font-medium ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Vaqtli rejim</h4>
                    <p className={`text-sm ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  <input
                    ...
                    onChange={(e) =>
                      setSettings((prev) => ({ ...prev, timePerQuestion: Number.parseInt(e.target.value) }))
                    }
                ...
                <div className={`text-center p-3 rounded-lg ${theme === "dark" ? "bg-gray-700" : "bg-gray-100"}`}>
                  <p className={`text-sm ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}>
                    Jami vaqt: {Math.ceil((settings.selectedTest!.total_questions * settings.timePerQuestion) / 60)}{" "}
                    daqiqa
                  </p>
                </div>
              </div>
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
        ...
        >
          ...
          <p className={`text-sm ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}>Iltimos biroz kuting</p>
        </div>
      </div>
    )
  }
